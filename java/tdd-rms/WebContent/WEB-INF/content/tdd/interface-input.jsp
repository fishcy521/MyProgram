	...
	<head>
		...
		<script type="text/javascript">
			...
			function init() {
				...
				console.log("IHasParam="+'${entity.IHasParam}');
				console.log("has_param="+has_param);
				if(has_param == 'y'){
				...
				console.log($("input[name='rad_has_param']:checked").val());
			...
			function form_submit() {
				...
				$("[name='param_desc']").each(function(index,data){
					...
					console.log("tmp_name_val="+tmp_name_val+"||tmp_value_val="+tmp_value_val+"||tmp_desc_val="
							+tmp_desc_val+"||tmp_type_val="+tmp_type_val+"||tmp_required_val="+tmp_required_val);
					if (tmp_name_val == '') {
						alert("参数名称不能为空");
						$(this).focus();
					}
				...
				console.log("param_name_str="+param_name_str);
				console.log("param_value_str="+param_value_str);
				console.log("param_desc_str="+param_desc_str);
				console.log("param_type_str="+param_type_str);
				console.log("param_required_str="+param_required_str);
	...
	<body>
		<form id="inputForm" method="post">
			...
			<fieldset id="fieldset_json" style="display: none"><legend>json相关</legend>
				<div>
					<input class="button" type="button" id="btn_json" value="生成json" />
					<div>

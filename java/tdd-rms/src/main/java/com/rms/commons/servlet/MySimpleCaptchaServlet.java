package com.rms.commons.servlet;
...
public class MySimpleCaptchaServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		Builder builder = new Captcha.Builder(_width, _height);// _width,_height

		// ----------------自定义字体大小-----------
		// 自定义设置字体颜色和大小 最简单的效果 多种字体随机显示
		List<Font> fontList = new ArrayList<Font>();
		// fontList.add(new Font("Arial", Font.HANGING_BASELINE, 40));//可以设置斜体之类的
		fontList.add(new Font("Courier", Font.HANGING_BASELINE, 45));
		DefaultWordRenderer dwr = new DefaultWordRenderer(Color.red, fontList);

...
//		String e = desPlus.encrypt(WEIXIN.FXSHOP_ALPAY_CUSTOMER_LOGINNAME);
//		System.out.println(e);
//		String d = desPlus.decrypt(WEIXIN.FXSHOP_ALPAY_CUSTOMER_LOGINNAME);
//		System.out.println(d);

		// 使用新密钥
		/*DESPlus desPlus2 = new DESPlus(TaoDuoduo.WEIXIN_USER_DESPLUS);
		String e2 = desPlus2.encrypt("123456");
		System.out.println(e2);*/
		
		/*Map<String, String> paramMap = new HashMap<String, String>();
		paramMap.put("userId","2");
		String jsonParam = JSONObject.fromObject(paramMap).toString();
		DESPlus crypt = new DESPlus(DESPlus.AES_MICHI_MIN);
		String str1="sfkpnF6Zd8Tkg1WVIYXJNHTQf4GMN+7lvd2+QS/AqIksGKZSV+Wv59dnBFEm5R1w";

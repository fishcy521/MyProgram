 ...
 */
package com.rms.modules.utils.web.struts2;
...
public class Struts2Utils {
    ...
    public static void renderExcel(final String excel, final String... headers) {
	render(ServletUtils.EXCEL_TYPE, excel, headers);
    }
